...
const commentsData = [
  {
    'avatar': '/static/assets/bonefix/images/w1.jpg',
    'name': 'Елена Стојанова',
    'stars': true,
    'text': 'Леле, фала многу за информациите! Веднаш ќе му порачам Bonefix Капсули на сопругот, бедниот едвај оди веќе година дена со болни колена.',
    'image': null,
    'answers': []
  },
  {
    'avatar': '/static/assets/bonefix/images/w2.jpg',
    'name': 'Ана Петрова',
    'stars': true,
  ...
  {
    'avatar': '/static/assets/bonefix/images/m2.jpg',
    'name': 'Леон Крстев',
    'stars': true,
    'text': 'Фала за корисната објава! Веднаш ги нарачав капсулите и се слушнав со поддршката, велат дека брзо им се распродава. Добро што стигнав на време!',
    'image': null,
    'answers': []
  },
  {
    'avatar': '/static/assets/bonefix/images/m3.jpg',
    'name': 'Илија Стојчев',
    'stars': true,
    'text': 'Со години мака мачам со болки во зглобовите и ми е преку глава да пијам апчиња. Ноќе не можам да спијам, ниту да се грижам за внуците ко што сакам. Сега озбилно размислувам за Bonefix Капсули. Ако ѝ помогнал на Катерина, се надевам ќе помогне и кај мене!',
    'image': null,
    'answers': []
  },
  {
    'avatar': '/static/assets/bonefix/images/m4.jpg',
    'name': 'Оливер Наумов',
    'stars': false,
    'text': 'Јас исто имав слични маки со години. Ме фаќаше паника, никако да се смират болките. Мама ми ги препорача Bonefix Капсулите и стварно е топ!',
    'image': null,
    'answers': []
  },
  {
    'avatar': '/static/assets/bonefix/images/m5.jpg',
    'name': 'Мартин Тошев',
    'stars': false,
    ...
    'answers': [
      {
        'avatar': '/static/assets/bonefix/images/m6.jpg',
        'name': 'Јаков Илиев',
        'stars': false,
        'text': 'Не брзај со операција, брат! И јас бев пред таков чекор. Јас почнав со Bonefix Капсули и болките ми исчезнаа, ко никогаш да ги немало.',
        'image': null
      }
    ]
  },
  {
    'avatar': '/static/assets/bonefix/images/w3.jpg',
    'name': 'Ела Трајкоска',
    'stars': true,
    'text': 'Како да ни земат пари, така многу доктори едвај чекаат да ни препишат секој месец инјекции или чудни лекови. И мене ми нудеа некој препарат, а не ни проверија со што веќе се лекувам. Добро е што Bonefix Капсулите се појавија, па можеме нешто поефикасно да пробаме.',
    'image': null,
    'answers': []
  },
  {
    'avatar': '/static/assets/bonefix/images/w4.jpg',
    'name': 'Миа Тодорова',
    'stars': false,
  ...
  {
    'avatar': '/static/assets/bonefix/images/m7.jpg',
    'name': 'Ноа Арсов',
    'stars': false,
    'text': 'Имам дегенеративни промени на \'рбетот, а Bonefix Капсулите ги користам одамна. Речиси и да немам влошувања оттогаш. Да не беше гелот, веројатно ќе завршев во количка. Докторите се чудеа, ама еве гледаме дека делува!',
    'image': null,
    'answers': [
      {
        'avatar': '/static/assets/bonefix/images/w5.jpg',
        'name': 'Зорица Милошевска',
        'stars': false,
        'text': 'Фала за споделувањето. Навистина сте храбар човек. Баш ќе ги нарачам капсулите по ваша препорака.',
        'image': null
      }
    ]
  },
  {
    'avatar': '/static/assets/bonefix/images/w6.jpg',
  ...
  {
    'avatar': '/static/assets/bonefix/images/w7.jpg',
    'name': 'Хана Христова',
    'stars': false,
    'text': 'Мојот ревматолог ми ги препиша Bonefix Капсулите, ама тек почнав. Ќе видам како ќе биде понатаму.',
    'image': null,
    'answers': []
  },
  {
    'avatar': '/static/assets/bonefix/images/m9.jpg',
    'name': 'Бене Дамјанов',
    'stars': true,
  ...
  {
    'avatar': '/static/assets/bonefix/images/w8.jpg',
    'name': 'Емили Стојковска',
    'stars': false,
    'text': 'Некој пробал ли да го порача Bonefix Капсулите од официјалната страница? Наводно брзо се распродава. Дали е тоа нормално?',
    'image': null,
    'answers': []
  },
  {
    'avatar': '/static/assets/bonefix/images/m11.jpg',
  ...
  {
    'avatar': '/static/assets/bonefix/images/w10.jpg',
    'name': 'Лина Доревска',
    'stars': false,
    ...
    'answers': [
      {
        'avatar': '/static/assets/bonefix/images/m12.jpg',
        'name': 'Хенрик Вишне',
        'stars': false,
  ...
  {
    'avatar': '/static/assets/bonefix/images/m13.jpg',
    'name': 'Јон Пасков',
    'stars': true,
    'text': 'Точно е, и јас ги купив капсулите. Треба да си истраен со целиот третман, и ќе се чувствуваш ко нов. Конечно да се решам од долгогодишни маки! Изгубеното време нема да се врати, ама барем живот без болки ќе продоложам!',
    'image': null,
    'answers': []
  },
  {
    'avatar': '/static/assets/bonefix/images/Anna-Schulz.jpg',
    'name': 'Ана Шулц (во Скопје)',
    'stars': true,
    'text': 'Јас му го порачав на мајка ми. Сѐ живо испробавме, одевме кај разни специјалисти, ама без успех. Последниве шест месеци едвај стануваше. Сега, по неколку недели со Bonefix Капсули, заедно шетаме по парк! Навистина прекрасно!',
    'image': null,
    'answers': []
  },
  {
    'avatar': '/static/assets/bonefix/images/m14.jpg',
    'name': 'Јаков Принц',
    'stars': false,
    ...
    'answers': [
      {
        'avatar': '/static/assets/bonefix/images/w11.jpg',
        'name': 'Рута Стеванова',
        'stars': false,
  ...
  {
    'avatar': '/static/assets/bonefix/images/m15.jpg',
    'name': 'Лука Михаилов',
    'stars': true,
    'text': 'Јас ги испробав Bonefix Капсулите и сум презадоволен. Седум години се борев со артритис, мислев дека засекогаш ќе зависам од апчиња. Сега сум без болка! Секому би му препорачал да проба.',
    'image': null,
    'answers': []
  },
  {
    'avatar': '/static/assets/bonefix/images/m16.jpg',
    'name': 'Конрад Блажев',
    'stars': false,
  ...
  {
    'avatar': '/static/assets/bonefix/images/m17.jpg',
    'name': 'Карло Кралев',
    'stars': false,
    'text': 'Имам 63 години, а уште од 53-та со колена се мачам. Едвај издржував. Пред три месеци, еден стар пријател ме убеди да ги пробам Bonefix Капсулите и сега трчкам ко млада срна! Неверојатен производ!',
    'image': null,
    'answers': []
  },
  {
    'avatar': '/static/assets/bonefix/images/m18.jpg',
    'name': 'Харалд Лазаров',
    'stars': false,
  ...
  {
    'avatar': '/static/assets/bonefix/images/m19.jpg',
    'name': 'Даниел Мојсов',
    'stars': false,
  ...
  {
    'avatar': '/static/assets/bonefix/images/m21.jpg',
    'name': 'Оскар Бектов',
    'stars': false,
  ...
  {
    'avatar': '/static/assets/bonefix/images/m22.jpg',
    'name': 'Ксавер Тошев',
    'stars': false,
    'text': 'И јас имав слично искуство со Bonefix Капсулите. Порано ми ставаа инјекции, ама од ко го користам гелот, како да си добив нов живот. Две месеци сум без болка!',
    'image': null,
    'answers': []
  },
  {
    'avatar': '/static/assets/bonefix/images/w12.jpg',
    'name': 'Ирис Ачкова',
    'stars': false,
  ...
  {
    'avatar': '/static/assets/bonefix/images/m23.jpg',
    'name': 'Исак Петров',
    'stars': false,
    'text': 'Бев кај помлад доктор кој со ентузијазам ми ги препорача Bonefix Капсулите. Кај мене делуваше одма. Болката ми се изгуби, ама го користев се’ до крај, како што пишува. По три недели немам никакви проблеми. Супер се чувствувам!',
    'image': null,
    'answers': []
  },
  {
    'avatar': '/static/assets/bonefix/images/m24.jpg',
    'name': 'Левин Валендер',
    'stars': false,
    'text': 'Комшијата ми има 72 години и постојано се жалеше на грбот. Сега гледам активен е, ко нов човек. Ми кажа дека син му му ги набавил Bonefix Капсулите. Од тогаш е сосема друга приказна!',
    'image': null,
    'answers': []
  },
  {
    'avatar': '/static/assets/bonefix/images/w13.jpg',
    'name': 'Скарлет Роџер',
    'stars': false,
  ...
  {
    'avatar': '/static/assets/bonefix/images/w14.jpg',
    'name': 'Зара Дичева',
    'stars': false,
  ...
  {
    'avatar': '/static/assets/bonefix/images/w15.jpg',
    'name': 'Мадлена Василева',
    'stars': false,
    'text': 'Првпат слушнав за Bonefix Капсули на еден форум за болки во зглобови. Многумина ги фалеа, па решив да ги купам. Ги користам трети ден, и веќе болката ми е помала, а крцкањето во коленото речиси исчезна. Сѐ уште има малку оток, ама многу подобро од порано. Ќе ве известам како иде – засега сум презадоволна!',
    'image': null,
    'answers': []
  },
  {
    'avatar': '/static/assets/bonefix/images/w16.jpg',
